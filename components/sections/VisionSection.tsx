          ...
          >
            <div style={{ width: "fit-content", marginBottom: "2.5rem" }}>
              <Typography variant="h2" style={{ marginBottom: "0.75rem" }}>
                <Typography variant="span" className="cyber-sweep">OUR</Typography> <Typography variant="span" className="cyber-sweep-red">VISION</Typography>
              </Typography>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "1.5rem" }}>
              ...
              <Typography variant="b2" style={{ color: "var(--text-secondary)" }}>
                We believe in the transformative power of games. Every project we undertake is a journey. A journey of exploration, creativity, and collaboration. We immerse ourselves in our clients&apos; visions, infusing them with our expertise and passion to create games that resonate with players on a profound level.
              </Typography>
            </div>
          </motion.div>
